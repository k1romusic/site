...
export const AiToolsOverviewSection: React.FC = () => {
  ...
  return (
    <section id="ai-tools-overview" className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5">
      <GlassCard
        hoverEffect={false}
        className="p-6 sm:p-10 lg:p-12 relative overflow-hidden border border-[#FFC300]/30 bg-gradient-to-br from-[#FFC300]/[0.08] via-white/[0.03] to-transparent shadow-[0_15px_40px_rgba(0,0,0,0.5)] transition-all duration-500"
      >
        {/* Drifting Golden Ambient Glow Behind Card */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#FFC300]/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
            ...
            <Link
              to="/plugins"
              className="inline-flex items-center gap-3 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-[#FFC300] to-[#e6b000] text-black font-black text-xs sm:text-sm uppercase tracking-wider hover:scale-105 active:scale-95 transition-all shadow-[0_0_25px_rgba(255,195,0,0.35)] shrink-0 self-start md:self-auto cursor-pointer"
            >
          ...
          {/* 3 Program Miniatures with short description: each links directly to its banner /plugins#id */}
              ...
              >
                ...
                <div className="relative aspect-[16/10] rounded-xl overflow-hidden bg-black/80 border border-white/10 mb-4">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/item:opacity-100 transition-opacity bg-black/40">
                    <span className="px-3 py-1.5 rounded-lg bg-[#FFC300] text-black font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5 shadow-lg">
                      <Eye className="w-3 h-3" />
                      {lang === 'ru' ? 'Открыть плагин' : 'View Plugin'}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-[#F5F0E8]/65 leading-relaxed mb-3">
                    {plugin.desc}
                  </p>
                  <div className="text-[11px] font-bold text-[#FFC300] flex items-center gap-1 group-hover/item:translate-x-1 transition-transform">
                    <span>{lang === 'ru' ? 'Смотреть описание и демо' : 'Details & Demo'}</span>
