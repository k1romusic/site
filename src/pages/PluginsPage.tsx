...
export const PluginsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#252422] text-[#F5F0E8] relative selection:bg-[#FFC300] selection:text-black">
      ...
      <main className="flex-1 relative z-10 py-12 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        {/* Top Breadcrumb / Back Link */}
        <div className="mb-8">
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-[#FFC300] hover:text-[#FFC300] text-xs font-semibold text-[#F5F0E8] transition-all cursor-pointer hover:scale-105"
          >
            <ArrowLeft className="w-4 h-4 text-[#FFC300]" />
            <span>{lang === 'ru' ? 'Назад на главную' : 'Back to Home'}</span>
          </Link>
        </div>
        ...
        <div className="mb-14 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#FFC300]/15 border border-[#FFC300]/30 text-xs font-bold uppercase tracking-[0.25em] text-[#FFC300] mb-4">
            ...
            <span>{lang === 'ru' ? 'ВИТРИНА СОФТА И ПЛАГИНОВ' : 'SOFTWARE & PLUGINS SHOWCASE'}</span>
          </div>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#F5F0E8] uppercase mb-4">
            {lang === 'ru' ? 'ИНСТРУМЕНТЫ K1RO' : 'K1RO DSP & AI TOOLS'}
          </h1>
          <p className="text-sm sm:text-base text-[#F5F0E8]/70 max-w-2xl leading-relaxed">
            {lang === 'ru'
              ? 'Профессиональные VST3/AU плагины и DSP-алгоритмы, разработанные для современной музыкальной индустрии. Реальные скриншоты интерфейсов, чистый звук без артефактов и регулярные обновления.'
              : 'Professional VST3/AU audio plugins and neural DSP tools engineered for modern music creators. Zero digital artifacts and ultra-low latency.'}
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between">
                  <div>
                    ...
                    {/* Plugin Name */}
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-[#F5F0E8] uppercase mb-2">
                      {plugin.name}
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                      {plugin.features.map((feat, fIdx) => (
                        <div key={fIdx} className="flex items-start gap-2.5">
                          ...
                          <div>
                            <h3 className="text-xs font-bold text-[#F5F0E8] uppercase tracking-wide">
                              {feat.title[lang]}
                            </h3>
                      ...
                      <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/60 group/img aspect-[16/10] flex items-center justify-center">
                        ...
                        <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between pointer-events-none">
                          <span className="px-2.5 py-1 rounded-lg bg-black/80 backdrop-blur-md border border-white/10 text-[9px] font-mono text-[#FFC300]">
                            {plugin.id === 'ai-voice' && 'Гайд-трек + Клонированный вокал'}
                            {plugin.id === 'stem-studio' && 'Мультитрек: вокал, бас, ударные'}
                          </span>
        ...
        {/* Modal for Full-Size Screenshot View */}
        {selectedScreenshot && (
          <div
